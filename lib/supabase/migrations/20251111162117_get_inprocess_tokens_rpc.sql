...
BEGIN
  ...
  WITH filtered_tokens AS (
    ...
    GROUP BY
      ...
      t."chainId", t."createdAt", t.hidden, t."payoutRecipientNotDefaultAdmin", a.username
  )
  ...
  WITH filtered_tokens AS (
    SELECT DISTINCT
      ...
      t."payoutRecipientNotDefaultAdmin",
      a.username,
      COALESCE(
  ...
  SELECT json_agg(
    json_build_object(
      ...
      'createdAt', "createdAt",
      'hidden', t_hidden,
      'payoutRecipientNotDefaultAdmin', "payoutRecipientNotDefaultAdmin",
      'username', username,
  ...
  FROM (
    SELECT
      ...
      "createdAt",
      t_hidden,
      "payoutRecipientNotDefaultAdmin",
      username,
      tokenAdmins
