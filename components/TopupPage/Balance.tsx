...
export function Balance() {
  const { isLoading, balance } = useSmartWalletProvider();
    ...
    <Card className="p-6 space-y-4 h-fit">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="text-sm font-archivo-medium text-grey-primary">USDC Balance</p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-1">
        {isLoading ? (
          ...
          <div className="flex items-baseline gap-2">
            ...
            <span className="text-lg text-grey-primary font-archivo-medium">USDC</span>
          </div>
        )}
