...
const AirdropRecipientItem = ({ recipient, isActive, onClick }: AirdropRecipientItemProps) => {
  return (
    <button
      ...
      className={`rounded-lg px-4 py-2 text-left font-archivo text-sm transition-colors ${
        isActive
          ? "bg-grey-moss-300 text-grey-eggshell"
    ...
    >
      ...
      {recipient.username && (
        <div className={`text-xs ${isActive ? "text-grey-eggshell/80" : "text-neutral-500"}`}>
