...
function PageHeaderDescription({
  ...
  return (
    <Balance
      className={cn("text-foreground max-w-[750px] text-center text-lg font-light", className)}
      {...props}
    />
  );
}
...
function PageActions({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return (
    <div
      className={cn("flex w-full items-center justify-center space-x-4 py-4 md:pb-2", className)}
      {...props}
    />
  );
}
